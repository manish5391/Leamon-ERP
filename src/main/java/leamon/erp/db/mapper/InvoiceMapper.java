...
public interface InvoiceMapper {
	...
	final String update = "UPDATE INVOICE_BILL SET PARTYINFOID = #{partyinfoID}, REMAININGBILLAMOUNT = #{remainingBillAmount}, REMAININGWITHOUTBILLAMOUNT = #{remainingWithoutBillAmount}, INVOICENUM = #{invoicNum}, INVOICEDATE = #{invoicDate}, "
