...
public class LeamonAutoTextFieldSuggestor<T extends List<E>, E> extends JWindow implements KeyListener, FocusListener, ActionListener{
	...
	public LeamonAutoTextFieldSuggestor() {
		lst = new JXList();
		lst.setCellRenderer(new AccountInfoCellRender());
	...
	public LeamonAutoTextFieldSuggestor(JComponent jc, InventoryUI ui) {
		this();
		this.ui  = ui;
