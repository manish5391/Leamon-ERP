...
public class LeamonAutoTextSuggestor<T> extends JWindow implements KeyListener, FocusListener, ActionListener{
	...
	public LeamonAutoTextSuggestor() {
		lst = new JList();
	...
	public LeamonAutoTextSuggestor(JComponent jc) {
		this();
	...
	public LeamonAutoTextSuggestor(JTable t, int col) {
		this(t);
		activeColumn = col;
	}
